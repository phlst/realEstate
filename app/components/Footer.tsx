        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              Helping you find your dream home since 2010. We&apos;re dedicated
              to providing exceptional real estate services with integrity and
              professionalism.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-start">
                <HomeIcon className="h-5 w-5 text-indigo-600 mr-2 mt-0.5" />
                <span>
                  123 Real Estate Blvd, Suite 456
                  <br />
                  Cityville, ST 12345
                </span>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-indigo-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © {currentYear} Premium Homes Realty. All rights reserved.
            </p>
